 ...
 *
 */
class CannerTodosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'canner_todos_ibfk_1' => ['type' => 'foreign', 'columns' => ['canner_id'], 'references' => ['canners', 'user_id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'canner_todos_ibfk_2' => ['type' => 'foreign', 'columns' => ['owner_id'], 'references' => ['owners', 'user_id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
